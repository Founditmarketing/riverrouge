      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-8 lg:gap-12">
          ...
          <motion.a
            ...
            whileHover={{ y: -10 }}
            className="group block relative overflow-hidden rounded-3xl bg-[var(--color-walnut)] text-white shadow-2xl shadow-black/10"
          >
          ...
          <motion.a
            href="/portfolio"
            whileHover={{ y: -10 }}
            className="group block relative overflow-hidden rounded-3xl bg-white shadow-2xl shadow-black/5"
          >
            <div className="aspect-[4/3] overflow-hidden">
              <img
