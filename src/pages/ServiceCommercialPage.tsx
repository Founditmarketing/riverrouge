...
const galleryImages = [
  "live_commercial_reception_desk.png",
  "live_commercial_lighting.png",
  "live_medical_dental_exam.png",
    ...
    <div className="min-h-screen bg-[var(--color-cloud)] selection:bg-[var(--color-cypress)] selection:text-white">
      ...
      <section className="relative h-[40vh] min-h-[400px] flex items-center justify-center overflow-hidden bg-[var(--color-walnut)] pt-16">
        <div
          ...
          style={{ backgroundImage: `url("/riverrougecommercialhero.jpeg")` }}
        >
        ...
        <div className="relative z-10 text-center px-6 text-white max-w-4xl mx-auto mt-12 md:mt-0">
          ...
          >
            ...
            <p className="text-lg text-white/80 font-light leading-relaxed max-w-2xl mx-auto">
              Striking corporate environments, executive boardrooms, and medical facilities engineered for aesthetic impact and enduring durability.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-24 px-6 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        >
          <h2 className="font-serif text-4xl md:text-5xl text-[var(--color-walnut)]">
            Executive Presence.<br/>Commercial Grade.
          </h2>
          <p className="text-lg text-[var(--color-ink)]/80 leading-relaxed font-light">
            We partner with leading architectural firms and regional developers to execute high-stakes commercial millwork. From monumental reception desks to acoustic wood-slat walls, our components combine world-class visual appeal with the rigorous durability required for high-traffic environments.
          </p>
          <ul className="space-y-4">
            {[
              "Impeccable reception desks and lobby focal points",
              "Executive conference tables and custom boardrooms",
              "Precision medical and dental operatory cabinetry",
              "Robust architectural paneling and integrated millwork"
            ].map((item, i) => (
        ...
        >
          <img 
            ...
            alt="Commercial architectural millwork installation" 
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {galleryImages.map((src, index) => (
              ...
              >
                <img 
                  src={`/${src}`} 
                  alt={`Commercial Millwork Preview ${index + 1}`} 
